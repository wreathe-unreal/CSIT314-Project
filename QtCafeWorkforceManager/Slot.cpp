...
Response<QVector<Slot>> Slot::GetAllSlots()
{
...
Response<QVector<Slot>> Slot::CreateSlot(Slot newSlot)
{
...
Response<Slot> Slot::GetSlot(int slotID)
{
...
Response<QVector<Slot>> Slot::SearchDate(QDate date)
{
    Response<QVector<Slot>> response;
...
Response<QVector<User>> Slot::GetUsersBySlotID(int SlotID)
{
...
Response<void> Slot::DeleteSlot(int SlotID)
{
...
Response<QVector<Slot>> Slot::UpdateSlot(Slot editedSlot)
{
    Response<QVector<Slot>> response = GetAllSlots();
...
Response<QVector<Slot>> Slot::SearchByUserID(int userID)
{
    Response<QVector<Slot>> response;
