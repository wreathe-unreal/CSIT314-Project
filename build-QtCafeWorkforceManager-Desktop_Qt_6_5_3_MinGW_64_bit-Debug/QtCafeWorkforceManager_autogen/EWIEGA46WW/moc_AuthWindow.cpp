...
#include "../../../QtCafeWorkforceManager/AuthWindow.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAuthWindowENDCLASS_t qt_meta_stringdata_CLASSAuthWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 27),  // "on_QLE_Username_textChanged"
        QT_MOC_LITERAL(63, 4),  // "arg1"
        QT_MOC_LITERAL(68, 26)   // "on_QLE_Password_textEdited"
    },
    "AuthWindow",
    "on_LoginButton_clicked",
    "",
...
void AuthWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_QLE_Username_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->on_QLE_Password_textEdited((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
